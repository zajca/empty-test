...
class MetadataFromSnowflakeWorkspaceTest extends ParallelWorkspacesTestCase
{
    ...
    public function testIncrementalLoadUpdateDataType(): void
    {
        ...
        $this->assertEventWithRetries($this->_client, $assertCallback, 'storage.tableAutomaticDataTypesNotUpdateColumnType', $tableId);
        ...
        $this->assertEventWithRetries($this->_client, $assertCallback, 'storage.tableAutomaticDataTypesNotUpdateColumnNullable', $tableId);
        ...
        $this->assertEventWithRetries($this->_client, $assertCallback, 'storage.tableAutomaticDataTypesNotUpdateColumnLength', $tableId);
