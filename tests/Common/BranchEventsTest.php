...
class BranchEventsTest extends StorageApiTestCase
{
    ...
    public function testCreatedEventAvailableInBranchOnly(): void
    {
        ...
        $this->assertEventWithRetries($branchAwareClient, $assertCallback, 'storage.componentConfigurationCreated');
    }
    ...
    public function testCreateBucketEvent(): void
    {
        ...
        $this->assertEventWithRetries($this->_client, $assertCallback, 'storage.bucketCreated', $testBucketId);
    }
